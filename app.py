...
st.header("How many collisions occur during given hour of day?")
...
if select == 'Pedestrians':
    ...
    st.write(original_data.query("injured_cyclists >= 1")[["on_street_name", "injured_cyclists"]].sort_values(by=['injured_cycleists'], ascending=False).dropna(how='any')[:5])
